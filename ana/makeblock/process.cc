...
// Last-Updated: 四 5月 25 22:49:35 2017 (+0800)
//           By: Hongyi Wu(吴鸿毅)
//     Update #: 108
...
void process()
{
  ...
  TString Macro="MakeBlock";//将会在当前文件所在目录生成 XXXXXX.h XXXXXX.C 两个文件
  ...
  chain->Add("$Dir/../test400w.root");//采用通配符
  // chain->Add("$Dir/../sdnm4000w_1.root");//采用通配符
  // chain->Add("$Dir/../sdnm2000w.root");//采用通配符
